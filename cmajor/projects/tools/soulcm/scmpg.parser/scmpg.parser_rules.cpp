module scmpg.parser.rules;

namespace scmpg.parser.rules {
...
std::map<int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<int64_t, std::string> ruleNameMap = {
        { 6776994141483040769, "ParserFileParser.ParserFile" },
        { 6776994141483040770, "ParserFileParser.Usings" },
        { 6776994141483040771, "ParserFileParser.Grammar" },
        { 6776994141483040772, "ParserFileParser.GrammarStatement" },
        { 6776994141483040773, "ParserFileParser.LexerStatement" },
        { 6776994141483040774, "ParserFileParser.MainStatement" },
        { 6776994141483040775, "ParserFileParser.UsingStatement" },
        { 6776994141483040776, "ParserFileParser.RuleStatement" },
        { 6776994141483040777, "ParserFileParser.ParametersAndVariables" },
        { 6776994141483040778, "ParserFileParser.ParamOrVariable" },
        { 6776994141483040779, "ParserFileParser.Name" },
        { 6776994141483040780, "ParserFileParser.ReturnType" },
        { 6776994141483040781, "ParserFileParser.RuleBody" },
        { 6776994141483040782, "ParserFileParser.Choice" },
        { 6776994141483040783, "ParserFileParser.Sequence" },
        { 6776994141483040784, "ParserFileParser.Difference" },
        { 6776994141483040785, "ParserFileParser.List" },
        { 6776994141483040786, "ParserFileParser.Prefix" },
        { 6776994141483040787, "ParserFileParser.Postfix" },
        { 6776994141483040788, "ParserFileParser.Primary" },
        { 6776994141483040789, "ParserFileParser.RuleCall" },
        { 6776994141483040790, "ParserFileParser.Nonterminal" },
        { 6776994141483040791, "ParserFileParser.Primitive" },
        { 6776994141483040792, "ParserFileParser.Grouping" },
        { 6776994141483040793, "ParserFileParser.Char" },
        { 6776994141483040794, "ParserFileParser.StringOrCharSet" },
        { 6776994141483040795, "ParserFileParser.MainKeyword" },
        { 6776994141483040796, "ParserFileParser.EmptyKeyword" },
        { 6776994141483040797, "ParserFileParser.AnyKeyword" },
        { 6776994141483040798, "ParserFileParser.VarKeyword" },
        { 4182902523981463553, "ScmpgFileParser.ScmpgFile" },
        { 4182902523981463554, "ScmpgFileParser.Declaration" },
        { 4182902523981463555, "ScmpgFileParser.ParserFileDeclaration" },
