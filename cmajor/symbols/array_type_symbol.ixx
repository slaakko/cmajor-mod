...
{
public:
    ArrayTypeSymbol(const soul::ast::SourcePos& sourcePos_, const boost::uuids::uuid& sourceModuleId_, const std::u32string& name_);
    ArrayTypeSymbol(const soul::ast::SourcePos& sourcePos_, const boost::uuids::uuid& sourceModuleId_, const std::u32string& name_, TypeSymbol* elementType_, int64_t size_);
...
{
public:
    ArrayLengthFunction(const soul::ast::SourcePos& sourcePos_, const boost::uuids::uuid& sourceModuleId_, const std::u32string& name_);
...
{
public:
    ArrayBeginFunction(const soul::ast::SourcePos& sourcePos_, const boost::uuids::uuid& sourceModuleId_, const std::u32string& name_);
...
{
public:
    ArrayEndFunction(const soul::ast::SourcePos& sourcePos_, const boost::uuids::uuid& sourceModuleId_, const std::u32string& name_);
...
{
public:
    ArrayCBeginFunction(const soul::ast::SourcePos& sourcePos_, const boost::uuids::uuid& sourceModuleId_, const std::u32string& name_);
...
{
public:
    ArrayCEndFunction(const soul::ast::SourcePos& sourcePos_, const boost::uuids::uuid& sourceModuleId_, const std::u32string& name_);
...
public:
    ...
    void GenerateCall(cmajor::ir::Emitter& emitter, std::vector<cmajor::ir::GenObject*>& genObjects, cmajor::ir::OperationFlags flag, const soul::ast::SourcePos& sourcePos, const boost::uuids::uuid& moduleId) override;
    bool IsBasicTypeOperation() const override { return true; }
