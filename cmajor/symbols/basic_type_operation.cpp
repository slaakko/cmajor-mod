...
BasicTypeCopyCtor::BasicTypeCopyCtor(TypeSymbol* type) : FunctionSymbol(SymbolType::basicTypeCopyCtor, soul::ast::SourcePos(), util::nil_uuid(), U"@constructor")
{
    ...
    AddMember(thisParam);
    ParameterSymbol* thatParam = new ParameterSymbol(soul::ast::SourcePos(), util::nil_uuid(), U"that");
...
BasicTypeMoveCtor::BasicTypeMoveCtor(TypeSymbol* type) : FunctionSymbol(SymbolType::basicTypeMoveCtor, soul::ast::SourcePos(), util::nil_uuid(), U"@constructor")
{
    ...
    AddMember(thisParam);
    ParameterSymbol* thatParam = new ParameterSymbol(soul::ast::SourcePos(), util::nil_uuid(), U"that");
    thatParam->SetType(type->AddRvalueReference(soul::ast::SourcePos(), util::nil_uuid()));
    AddMember(thatParam);
    ComputeName();
    if (type->IsBasicTypeSymbol())
    {
...
BasicTypeCopyAssignment::BasicTypeCopyAssignment(TypeSymbol* type, TypeSymbol* voidType) : FunctionSymbol(SymbolType::basicTypeCopyAssignment, soul::ast::SourcePos(), util::nil_uuid(), U"operator=")
{
...
BasicTypeReturn::BasicTypeReturn(TypeSymbol* type) : FunctionSymbol(SymbolType::basicTypeReturn, soul::ast::SourcePos(), util::nil_uuid(), U"@return")
{
    SetGroupName(U"@return");
    SetAccess(SymbolAccess::public_);
    ParameterSymbol* valueParam = new ParameterSymbol(soul::ast::SourcePos(), util::nil_uuid(), U"value");
