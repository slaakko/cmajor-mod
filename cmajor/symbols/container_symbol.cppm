...
public:
    ...
    virtual void AddMember(Symbol* member, Context* context);
    void AddOwnedMember(Symbol* ownedMember, Context* context);
    std::unique_ptr<Symbol> RemoveMember(int symbolIndex) override;
    void Accept(SymbolCollector* collector) override;
    void Clear();
    std::string TypeString(Context* context) const override { return "container"; }
...
private:
    ...
    FunctionGroupSymbol* MakeFunctionGroupSymbol(const std::u32string& groupName, const soul::ast::Span& span, Context* context);
    ConceptGroupSymbol* MakeConceptGroupSymbol(const std::u32string& groupName, const soul::ast::Span& span, Context* context);
    ClassGroupTypeSymbol* MakeClassGroupTypeSymbol(const std::u32string& groupName, const soul::ast::Span& span, Context* context);
    GlobalVariableGroupSymbol* MakeGlobalVariableGroupSymbol(const std::u32string& groupName, const soul::ast::Span& span, Context* context);
};
