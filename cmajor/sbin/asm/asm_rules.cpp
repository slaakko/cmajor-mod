...
std::map<int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<int64_t, std::string> ruleNameMap = {
        ...
        { 4519251244111364116, "AsmParser.AddExpr" },
        { 4519251244111364117, "AsmParser.MulExpr" },
        { 4519251244111364118, "AsmParser.AddOp" },
        { 4519251244111364119, "AsmParser.MulOp" },
        { 4519251244111364120, "AsmParser.UnaryExpr" },
        { 4519251244111364121, "AsmParser.UnaryOp" },
        { 4519251244111364122, "AsmParser.PrimaryExpr" },
        { 4519251244111364123, "AsmParser.ContentExpr" },
        { 4519251244111364124, "AsmParser.SizeExpr" },
        { 4519251244111364125, "AsmParser.SizePrefix" },
        { 4519251244111364126, "AsmParser.ParenthesizedExpr" },
        { 4519251244111364127, "AsmParser.Register" },
        { 4519251244111364128, "AsmParser.Value" },
        { 4519251244111364129, "AsmParser.CodeSection" },
        { 4519251244111364130, "AsmParser.CodeSectionHeader" },
        { 4519251244111364131, "AsmParser.FunctionDefinition" },
        { 4519251244111364132, "AsmParser.FunctionHeader" },
        { 4519251244111364133, "AsmParser.FunctionTrailer" },
        { 4519251244111364134, "AsmParser.FunctionBody" },
        { 4519251244111364135, "AsmParser.InstructionLine" },
        { 4519251244111364136, "AsmParser.Instruction" },
        { 4519251244111364137, "AsmParser.OpCode" },
        { 5311107904844070913, "AsmInstructionLineParser.InstructionLine" }
    };
    return &ruleNameMap;
}
