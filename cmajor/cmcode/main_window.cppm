...
public:
    ...
    void GotoDefinition(cmajor::ast::Project* project, const std::string& identifier, const bs::DefinitionSourceLocation& sourceLocation);
    void GotoCursor(const common::SourceLoc& sourceLocation);
    void GotoLocation(const bs::DefinitionSourceLocation& location);
...
private:
    ...
    void HandleBuildReply(bs::BuildReply& buildReply);
    ...
    void HandleFramesReply(const db::FramesReply& framesReply);
...
*/
    ...
    bool GetDefinitionSourceLocationAt(const wing::Point& loc, wing::TextView* textView, std::string& identifier, bs::DefinitionSourceLocation& sourceLocation);
    int GetEndColumn(wing::TextView* textView, const bs::DefinitionSourceLocation& sourceLocation) const;
    cmajor::ast::Project* CurrentProject();
    bs::DefinitionSourceLocation CurrentLocation() const;
    ...
    wing::ToolButton* stopBuildServerToolButton;
