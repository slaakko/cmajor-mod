...
AboutDialog::AboutDialog() :
    Window(wing::WindowCreateParams().WindowClassName("cmcode.AboutDialog").Location(wing::DefaultLocation()).WindowStyle(wing::DialogWindowStyle()).Text("About").
