...
export namespace cmajor::container::file::lexer {

std::mutex& MakeLexerMtx();

template<typename Char>
struct CmajorContainerFileLexer;

template<typename Char>
soul::lexer::Lexer<CmajorContainerFileLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName);

template<typename Char>
soul::lexer::Lexer<CmajorContainerFileLexer<Char>, Char> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const Char* start, const Char* end, const std::string& fileName);

soul::ast::slg::TokenCollection* GetTokens();

struct CmajorContainerFileLexer_Variables : public soul::lexer::Variables
{
    CmajorContainerFileLexer_Variables();
};

template<typename Char>
struct CmajorContainerFileLexer
{
    using Variables = CmajorContainerFileLexer_Variables;
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>("cmajor.container.file.lexer.classmap");
    return classmap;
}
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>(moduleFileName, "cmajor.container.file.lexer.classmap", resourceFlags);
    return classmap;
}
...
soul::lexer::Lexer<CmajorContainerFileLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName)
{
    ...
    auto lexer = soul::lexer::Lexer<CmajorContainerFileLexer<Char>, Char>(start, end, fileName);
