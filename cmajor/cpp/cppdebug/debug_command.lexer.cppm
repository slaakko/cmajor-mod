// this file has been automatically generated from 'C:/work/cmajor-mod/cmajor/cpp/cppdebug/debug_command.lexer' using soul lexer generator slg version 5.0.0
...
template<typename Char>
soul::lexer::Lexer<DebugCommandLexer<Char>, Char> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const Char* start, const Char* end, const std::string& fileName);
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>(moduleFileName, "cmajor.debug.command.lexer.classmap", resourceFlags);
    return classmap;
}
