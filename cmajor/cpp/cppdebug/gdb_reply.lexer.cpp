...
module cmajor.debug.gdb.reply.lexer;
...
{
    static soul::ast::slg::TokenCollection tokens("cmajor.debug.gdb.reply.lexer.tokens");
    if (!tokens.Initialized())
    {
        ...
        tokens.AddToken(new soul::ast::slg::Token(IDENTIFIER, "IDENTIFIER", "identifier"));
...
GdbReplyLexer_Variables::GdbReplyLexer_Variables()
{
}
