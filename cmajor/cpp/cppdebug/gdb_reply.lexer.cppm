// this file has been automatically generated from 'C:/work/cmajor-mod/cmajor/cpp/debug/gdb_reply.lexer' using soul lexer generator slg version 4.1.0
...
template<typename Char>
soul::lexer::Lexer<GdbReplyLexer<Char>, Char> MakeLexer(const std::string& moduleFileName, const Char* start, const Char* end, const std::string& fileName);
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>(moduleFileName, "cmajor.debug.gdb.reply.lexer.classmap");
    return classmap;
}
