// this file has been automatically generated from 'C:/work/cmajor-mod/cmajor/cpp/cppdebug/gdb_reply.lexer' using soul lexer generator slg version 5.0.0
...
export namespace cmajor::debug::gdb::reply::lexer {

std::mutex& MakeLexerMtx();

template<typename Char>
struct GdbReplyLexer;

template<typename Char>
soul::lexer::Lexer<GdbReplyLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName);

template<typename Char>
soul::lexer::Lexer<GdbReplyLexer<Char>, Char> MakeLexer(const std::string& moduleFileName, util::ResourceFlags resourceFlags, const Char* start, const Char* end, const std::string& fileName);

soul::ast::slg::TokenCollection* GetTokens();

struct GdbReplyLexer_Variables : public soul::lexer::Variables
{
    GdbReplyLexer_Variables();
};

template<typename Char>
struct GdbReplyLexer
{
    using Variables = GdbReplyLexer_Variables;
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>("cmajor.debug.gdb.reply.lexer.classmap");
    return classmap;
}
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>(moduleFileName, "cmajor.debug.gdb.reply.lexer.classmap", resourceFlags);
    return classmap;
}
...
soul::lexer::Lexer<GdbReplyLexer<Char>, Char> MakeLexer(const Char* start, const Char* end, const std::string& fileName)
{
    ...
    auto lexer = soul::lexer::Lexer<GdbReplyLexer<Char>, Char>(start, end, fileName);
...
} // namespace cmajor::debug::gdb::reply::lexer
