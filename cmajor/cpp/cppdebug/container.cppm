...
export module cmajor.debug.container;
...
public:
    ...
    std::unique_ptr<util::JsonValue> Deref();
    Pointer* PtrMember(const std::string& name);
    std::unique_ptr<util::JsonValue> ValueMember(const std::string& name);
...
public:
    ...
    virtual std::unique_ptr<util::JsonValue> Current() = 0;
...
public:
    ...
    std::unique_ptr<util::JsonValue> Current() override;
...
public:
    ...
    virtual std::unique_ptr<util::JsonValue> Subscript(const std::string& containerVarExpr, int64_t index) = 0;
    virtual std::string SubscriptExpressionString(const std::string& containerVarExpr, int64_t index) = 0;
    std::unique_ptr<util::JsonValue> Range(const std::string& containerVarExpr, int64_t rangeStart, int64_t rangeEnd);
...
public:
    ...
    std::unique_ptr<util::JsonValue> Subscript(const std::string& containerVarExpr, int64_t index) override;
