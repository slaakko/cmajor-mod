...
*/
    ...
    if (ferror(stdin))
    {
        errorStringHandle = InstallError("could not read from STDIN: " + util::PlatformStringToUtf8(std::strerror(errno)));
        return -1;
    }
    return result;
}
...
bool StdInputFile::GetError(int32_t& errorStringHandle) const
{
    if (std::ferror(stdin))
    {
        errorStringHandle = InstallError("STDIN: " + util::PlatformStringToUtf8(std::strerror(errno)));
        return true;
    }
    return false;
}
...
*/
    ...
    if (result != count)
    {
        errorStringHandle = InstallError("could not write to : " + name + ": " + util::PlatformStringToUtf8(std::strerror(errno)));
        return -1;
    }
    return result;
}
...
bool StdOutputFile::GetError(int32_t& errorStringHandle) const
{
    if (std::ferror(file))
    {
        errorStringHandle = InstallError(name + ": " + util::PlatformStringToUtf8(std::strerror(errno)));
        return true;
    }
    return false;
}
...
bool StdOutputFile::Flush(int32_t& errorStringHandle)
{
    ...
    if (result != 0)
    {
        errorStringHandle = InstallError("could not flush " + name + ": " + util::PlatformStringToUtf8(std::strerror(errno)));
        return false;
    }
    return true;
}
...
bool RegularFile::Close(int32_t& errorStringHandle)
{
    ...
    if (result != 0)
    {
        errorStringHandle = InstallError("could not close file '" + std::string(filePath) + "': " + util::PlatformStringToUtf8(std::strerror(errno)));
        return false;
    }
    return true;
}
...
int64_t RegularFile::Write(const uint8_t* buffer, int64_t count, int32_t& errorStringHandle)
{
    ...
    if (result != count)
    {
        errorStringHandle = InstallError("could not write to file '" + filePath + "': " + util::PlatformStringToUtf8(std::strerror(errno)));
        return -1;
    }
    return result;
}
...
int64_t RegularFile::Read(uint8_t* buffer, int64_t count, int32_t& errorStringHandle)
{
    ...
    if (ferror(file))
    {
        errorStringHandle = InstallError("could not read from file '" + filePath + "': " + util::PlatformStringToUtf8(std::strerror(errno)));
        return -1;
    }
    return result;
}
...
bool RegularFile::GetError(int32_t& errorStringHandle) const
{
    if (std::ferror(file))
    {
        errorStringHandle = InstallError(filePath + ": " + util::PlatformStringToUtf8(std::strerror(errno)));
        return true;
    }
    return false;
}
...
bool RegularFile::Seek(int64_t pos, Origin origin, int32_t& errorStringHandle)
{
    ...
    if (result != 0)
    {
        errorStringHandle = InstallError("could not seek file '" + filePath + "': " + util::PlatformStringToUtf8(std::strerror(errno)));
        return false;
    }
    return true;
}
...
int64_t RegularFile::Tell(int32_t& errorStringHandle)
{
    ...
    if (result == -1)
    {
        errorStringHandle = InstallError("could not tell file '" + filePath + "': " + util::PlatformStringToUtf8(std::strerror(errno)));
        return -1;
    }
    return result;
}
...
bool RegularFile::Flush(int32_t& errorStringHandle)
{
    ...
    if (result != 0)
    {
        errorStringHandle = InstallError("could not flush file '" + filePath + "': " + util::PlatformStringToUtf8(std::strerror(errno)));
        return false;
    }
    return true;
}
...
void* OpenFile(const char* filePath, OpenMode openMode, int32_t& errorStringHandle)
{
    ...
    if (!file)
    {
        errorStringHandle = InstallError("could not open file '" + std::string(filePath) + "': " + util::PlatformStringToUtf8(std::strerror(errno)));
        return nullptr;
    }
...
bool RtLastWriteTimeLess(const char* filePath1, const char* filePath2)
{
    ...
    if (std::filesystem::last_write_time(f1) < std::filesystem::last_write_time(f2))
    {
        return true;
    }
    return false;
...
int64_t RtGetFileSize(const char* filePath, int32_t& errorStringHandle)
{
    ...
    if (ec)
    {
        errorStringHandle = cmajor::rt::InstallError("could not get size of file '" + std::string(filePath) + "': " + util::PlatformStringToUtf8(ec.message()));
        return -1;
    }
    return fileSize;
}
...
bool RtRemoveFile(const char* filePath, int32_t& errorStringHandle)
{
    ...
    if (ec)
    {
        errorStringHandle = cmajor::rt::InstallError("could not remove file '" + std::string(filePath) + "': " + util::PlatformStringToUtf8(ec.message()));
        return false;
    }
    return true;
}
...
bool RtCopyFile(const char* sourceFilePath, const char* targetFilePath, int32_t& errorStringHandle)
{
    ...
    if (ec)
    {
        errorStringHandle = cmajor::rt::InstallError("could not copy file '" + std::string(sourceFilePath) + "': " + util::PlatformStringToUtf8(ec.message()));
        return false;
    }
    return true;
}
...
bool RtMoveFile(const char* sourceFilePath, const char* targetFilePath, int32_t& errorStringHandle)
{
    ...
    if (ec)
    {
        errorStringHandle = cmajor::rt::InstallError("could not move file '" + std::string(sourceFilePath) + "': " + util::PlatformStringToUtf8(ec.message()));
        return false;
    }
    return true;
}
