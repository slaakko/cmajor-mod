...
export module cmajor.cpp.backend.emitter;
...
class CppEmitter : public cmajor::ir::Emitter
{
public:
    CppEmitter(cmajor::ir::EmittingContext* emittingContext_);
...
private:
    ...
    ValueStack stack;
    cmajor::cpp::ir::CompileUnit* compileUnit;
    cmajor::cpp::ir::Context* context;
    std::unordered_map<void*, cmajor::cpp::ir::FunctionType*> functionIrTypeMap;
    std::unordered_map<util::uuid, cmajor::cpp::ir::Type*, util::UuidHash> irTypeTypeIdMap;
    cmajor::cpp::ir::Function* currentFunction;
    std::unordered_map<void*, cmajor::cpp::ir::Value*> irObjectMap;
    std::unordered_set<void*> vmtObjectCreatedSet;
    std::unordered_set<void*> staticObjectCreatedSet;
    std::unordered_map<void*, cmajor::cpp::ir::StructureType*> staticTypeMap;
    std::unordered_map<void*, cmajor::cpp::ir::ArrayType*> vmtObjectTypeMap;
    ...
    cmajor::cpp::ir::Value* objectPointer;
