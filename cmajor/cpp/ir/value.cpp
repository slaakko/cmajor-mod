...
{
    return util::ToUtf8(U"u'" + util::CharStr((char32_t)value) + U"'");
}
...
std::string StringValue::Name(Context& context)
{
    ...
    for (char c : value)
    {
        if (c == '"')
        {
            name.append("\\u00").append(util::ToHexString(static_cast<uint8_t>(c)));
        }
        else if (c == '\\')
        {
            name.append("\\u00").append(util::ToHexString(static_cast<uint8_t>(c)));
...
std::string WStringValue::Name(Context& context)
{
    ...
    for (char16_t c : value)
    {
        ...
        {
            name.append("\\u").append(util::ToHexString(static_cast<uint16_t>(c)));
        }
    }
    name.append("\"");
    return name;
...
std::string UStringValue::Name(Context& context)
{
    ...
    for (char16_t c : value)
    {
        if (c == '"')
        {
            name.append("\\U000000").append(util::ToHexString(static_cast<uint8_t>(c)));
        }
        else if (c == '\\')
        {
            name.append("\\U000000").append(util::ToHexString(static_cast<uint8_t>(c)));
        ...
        {
            name.append("\\U").append(util::ToHexString(static_cast<uint32_t>(c)));
        }
    }
    name.append("\"");
    return name;
