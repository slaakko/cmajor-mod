...
module cmajor.systemx.kernel.debug.msg;
...
std::string KeyPressedMessageParams(util::MemoryReader& reader)
{
...
std::string WriteScreenMessageParams(util::MemoryReader& reader)
{
    std::string params;
...
std::string TimerMessageParams(util::MemoryReader& reader)
{
    std::string params;
...
std::string ScreenMsgContentStr(int msgId, util::MemoryReader& reader)
{
...
std::string CompletionMsgContentStr(int msgId, util::MemoryReader& reader)
{
    std::string contentStr;
    switch (msgId)
    {
...
std::string MsgContentStr(int msgId, util::MemoryReader& reader)
{
    std::string contentStr;
...
{
    util::MemoryReader reader(msg.Data().data(), msg.Data().size());
