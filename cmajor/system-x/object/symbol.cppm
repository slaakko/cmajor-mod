...
export module cmajor.systemx.object.symbol;
...
constexpr ValueFlags operator|(ValueFlags left, ValueFlags right)
{
...
constexpr ValueFlags operator~(ValueFlags flags)
{
