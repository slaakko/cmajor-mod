...
module cmajor.systemx.object.binary.file;
...
BinaryFile* ReadBinaryFileHeader(util::BinaryStreamReader& reader, const std::string& filePath)
{
...
void Section::Write(util::BinaryStreamWriter& writer)
{
    switch (kind)
    {
    case SectionKind::fhdr:
...
void Section::Read(util::BinaryStreamReader& reader)
{
    try
    {
        ...
        if (baseAddress < 0 || baseAddress >= cmajor::systemx::machine::poolSegmentBaseAddress)
        {
            throw std::runtime_error("invalid base address " + util::ToHexString(static_cast<uint64_t>(baseAddress)));
        }
...
void Section::EmitByte(uint8_t x)
{
    ...
    {
        throw std::runtime_error("error emitting to file '" + file->FilePath() + "': invalid position " + util::ToHexString(static_cast<uint64_t>(pos)));
    }
}
...
void Section::EmitValue(const cmajor::systemx::object::Value& value)
{
...
void HeaderSection::Write(util::BinaryStreamWriter& writer)
{
    switch (File()->Kind())
    {
...
void HeaderSection::Read(util::BinaryStreamReader& reader)
{
    Section::Read(reader);
}
...
void SymbolSection::Read(util::BinaryStreamReader& reader)
{
    Section::Read(reader);
    SetPos(0);
...
void SymbolSection::Write(util::BinaryStreamWriter& writer)
{
...
void LinkSection::Read(util::BinaryStreamReader& reader)
{
    Section::Read(reader);
    SetPos(0);
    uint32_t count = ReadTetra();
...
void DebugSection::Read(util::BinaryStreamReader& reader)
{
    Section::Read(reader);
    SetPos(0);
    uint32_t count = ReadTetra();
...
void ResourceSection::Read(util::BinaryStreamReader& reader)
{
    Section::Read(reader);
    if (File()->Kind() == BinaryFileKind::objectFile)
    {
...
void ResourceSection::Write(util::BinaryStreamWriter& writer)
{
    Section::Write(writer);
...
void BinaryFile::Write(util::BinaryStreamWriter& writer)
{
    for (const auto& section : sections)
    {
        section->Write(writer);
...
void BinaryFile::Read(util::BinaryStreamReader& reader)
{
...
void ArchiveFile::Write(util::BinaryStreamWriter& writer)
{
...
void ArchiveFile::Read(util::BinaryStreamReader& reader)
{
