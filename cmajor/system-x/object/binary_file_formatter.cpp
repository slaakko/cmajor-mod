...
module cmajor.systemx.object.binary.file.formatter;

import cmajor.systemx.object.binary.file;

namespace cmajor::systemx::object {

BinaryFileFormatter::BinaryFileFormatter(cmajor::systemx::machine::Machine& machine_, BinaryFile* file_) : InstructionFormatter(machine_), file(file_), currentSection(nullptr)
{
}
