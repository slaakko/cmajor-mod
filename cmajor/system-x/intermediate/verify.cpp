...
module cmajor.systemx.intermediate.verify;
...
private:
    ...
    void CheckType(const std::string& typeDescription, Type* type, Type* assertedType, const std::string& expectedTypeDescription, Type* expected, const soul::ast::SourcePos& sourcePos);
...
void VerifierVisitor::CheckSameType(const std::string& typeDescription, Type* type, const std::string& expectedTypeDescription, Type* expected, const soul::ast::SourcePos& sourcePos)
{
    if (type != expected)
    {
...
void VerifierVisitor::CheckType(const std::string& typeDescription, Type* type, Type* assertedType, const std::string& expectedTypeDescription, Type* expected, const soul::ast::SourcePos& sourcePos)
{
...
void VerifierVisitor::CheckArithmeticType(Type* type, const std::string& typeDescription, const soul::ast::SourcePos& sourcePos)
{
...
void VerifierVisitor::CheckIntegerType(Type* type, const std::string& typeDescription, const soul::ast::SourcePos& sourcePos)
{
...
void VerifierVisitor::CheckIntegerOrBooleanType(Type* type, const std::string& typeDescription, const soul::ast::SourcePos& sourcePos)
{
...
void VerifierVisitor::CheckFloatingPointType(Type* type, const std::string& typeDescription, const soul::ast::SourcePos& sourcePos)
{
...
void VerifierVisitor::CheckPointerType(Type* type, const std::string& typeDescription, const soul::ast::SourcePos& sourcePos)
{
...
void VerifierVisitor::CheckArithmeticPointerOrBooleanType(Type* type, const std::string& typeDescription, const soul::ast::SourcePos& sourcePos)
{
...
void VerifierVisitor::CheckRegValue(Value* value, const soul::ast::SourcePos& sourcePos)
{
    if (value->IsRegValue())
    {
