        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::LabelNode(s, label));
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match StatementParser<LexerT>::LabeledStatement(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            statementNode.reset(new cmajor::ast::LabeledStatementNode(s, stmt.release()));
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::ReturnStatementNode(s, expr.release()));
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match StatementParser<LexerT>::IfStatement(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    soul::ast::Span s = soul::ast::Span();
    soul::ast::Span lparenSpan = soul::ast::Span();
    soul::ast::Span rparenSpan = soul::ast::Span();
    soul::ast::Span elseSpan = soul::ast::Span();
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            cmajor::ast::IfStatementNode *ifStatementNode = new cmajor::ast::IfStatementNode(s, cond.release(), thenS.release(), elseS.release());
            ...
            ifStatementNode->SetElseSpan(elseSpan);
            {
                ...
                #endif
                return soul::parser::Match(true, ifStatementNode);
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match StatementParser<LexerT>::WhileStatement(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            cmajor::ast::WhileStatementNode *whileStatementNode = new cmajor::ast::WhileStatementNode(s, cond.release(), stmt.release());
            ...
            whileStatementNode->SetRParenSpan(rparenSpan);
            {
                ...
                #endif
                return soul::parser::Match(true, whileStatementNode);
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match StatementParser<LexerT>::DoStatement(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    soul::ast::Span lparenSpan = soul::ast::Span();
    soul::ast::Span rparenSpan = soul::ast::Span();
    soul::ast::Span whileSpan = soul::ast::Span();
    std::unique_ptr<cmajor::ast::StatementNode> stmt;
    std::unique_ptr<cmajor::ast::Node> cond;
    soul::parser::Match match(false);
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            cmajor::ast::DoStatementNode *doStatementNode = new cmajor::ast::DoStatementNode(s, stmt.release(), cond.release());
            ...
            doStatementNode->SetRParenSpan(rparenSpan);
            {
                ...
                #endif
                return soul::parser::Match(true, doStatementNode);
            }
        }
        *parentMatch0 = match;
    }
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            ...
            rangeForStatementNode->SetRParenSpan(rparenSpan);
            {
                ...
                #endif
                return soul::parser::Match(true, rangeForStatementNode);
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match StatementParser<LexerT>::ForStatement(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            cmajor::ast::ForStatementNode *forStatementNode = new cmajor::ast::ForStatementNode(s, init.release(), cond.release(), loop.release(), stmt.release());
            ...
            forStatementNode->SetRParenSpan(rparenSpan);
            {
                ...
                #endif
                return soul::parser::Match(true, forStatementNode);
            }
        }
        *parentMatch0 = match;
    }
                            ...
                            {
                                {
                                    ...
                                    if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "ForLoopStatementExpr");
                                    #endif
                                    return soul::parser::Match(true, new cmajor::ast::ExpressionStatementNode(lexer.GetSpan(pos), expr.release()));
                                }
                            }
                            *parentMatch5 = match;
                        }
                        ...
                        {
                            {
                                ...
                                if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "ForLoopStatementExpr");
                                #endif
                                return soul::parser::Match(true, new cmajor::ast::EmptyStatementNode(lexer.GetSpan(pos)));
                            }
                        }
                        *parentMatch7 = match;
                    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::BreakStatementNode(s));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::ContinueStatementNode(s));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::GotoStatementNode(s, target));
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match StatementParser<LexerT>::SwitchStatement(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    soul::ast::Span lparenSpan = soul::ast::Span();
    soul::ast::Span rparenSpan = soul::ast::Span();
    soul::ast::Span beginBraceSpan = soul::ast::Span();
    soul::ast::Span endBraceSpan = soul::ast::Span();
                        ...
                        if (match.hit)
                        {
                            ...
                            soul::parser::Match* parentMatch12 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch13 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        switchStatementNode.reset(new cmajor::ast::SwitchStatementNode(s, cond.release()));
                                    }
                                    *parentMatch13 = match;
                                }
                                *parentMatch12 = match;
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch16 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch17 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    beginBraceSpan = lexer.GetSpan(pos);
                                }
                                *parentMatch17 = match;
                            }
                            *parentMatch16 = match;
            ...
            if (match.hit)
            {
                ...
                soul::parser::Match* parentMatch25 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch26 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            endBraceSpan = lexer.GetSpan(pos);
                        }
                        *parentMatch26 = match;
                    }
                    *parentMatch25 = match;
            ...
            soul::parser::Match* parentMatch2 = &match;
            {
                ...
                soul::parser::Match* parentMatch3 = &match;
                {
                    ...
                    soul::parser::Match* parentMatch4 = &match;
                    {
                        ...
                        if (match.hit)
                        {
                            caseStatementNode.reset(new cmajor::ast::CaseStatementNode(lexer.GetSpan(pos)));
                        }
                        *parentMatch4 = match;
                    }
                    *parentMatch3 = match;
                                ...
                                soul::parser::Match* parentMatch8 = &match;
                                {
                                    ...
                                    soul::parser::Match* parentMatch9 = &match;
                                    {
                                        ...
                                        soul::parser::Match* parentMatch10 = &match;
                                        {
                                            ...
                                            if (match.hit)
                                            {
                                                caseStatementNode->AddCaseSpan(lexer.GetSpan(pos));
                                            }
                                            *parentMatch10 = match;
                                        }
                                        *parentMatch9 = match;
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                defaultStatementNode.reset(new cmajor::ast::DefaultStatementNode(s));
                            }
                            *parentMatch6 = match;
                        }
                        *parentMatch5 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::GotoCaseStatementNode(s, caseExpr.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::GotoDefaultStatementNode(s));
            }
        }
        *parentMatch0 = match;
    }
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            context->PopParsingExpressionStatement();
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::ExpressionStatementNode(s, expr.release()));
            }
        }
        else
        {
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::AssignmentStatementNode(s, target.release(), source.release()));
            }
        }
        *parentMatch0 = match;
    }
                    ...
                    if (match.hit)
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch7 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    constructionStatementNode.reset(new cmajor::ast::ConstructionStatementNode(s, type.release(), id.release()));
                                }
                                *parentMatch7 = match;
                            }
                            *parentMatch6 = match;
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::DeleteStatementNode(s, ptr.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::DestroyStatementNode(s, ptr.release()));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::EmptyStatementNode(s));
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::ThrowStatementNode(s, exception.release()));
            }
        }
        *parentMatch0 = match;
    }
                ...
                if (match.hit)
                {
                    ...
                    soul::parser::Match* parentMatch5 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch6 = &match;
                        {
                            ...
                            if (match.hit)
                            {
                                tryStatementNode.reset(new cmajor::ast::TryStatementNode(s, tryBlock.release()));
                            }
                            *parentMatch6 = match;
                        }
                        *parentMatch5 = match;
...
soul::parser::Match StatementParser<LexerT>::Catch(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    soul::parser::Match* parentMatch0 = &match;
    {
        ...
        if (match.hit)
        {
            cmajor::ast::CatchNode *catchNode = new cmajor::ast::CatchNode(s, catchType.release(), catchId.release(), catchBlock.release());
            ...
            catchNode->SetRParenSpan(rparenSpan);
            {
                ...
                #endif
                return soul::parser::Match(true, catchNode);
            }
        }
        *parentMatch0 = match;
    }
        ...
        {
            {
                ...
                #endif
                return soul::parser::Match(true, new cmajor::ast::AssertStatementNode(s, expr.release()));
            }
        }
        *parentMatch0 = match;
    }
...
soul::parser::Match StatementParser<LexerT>::ConditionalCompilationStatement(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    soul::ast::Span s = soul::ast::Span();
    soul::ast::Span elifSpan = soul::ast::Span();
    soul::ast::Span elseSpan = soul::ast::Span();
    soul::ast::Span lparenSpan = soul::ast::Span();
    soul::ast::Span rparenSpan = soul::ast::Span();
                                ...
                                if (match.hit)
                                {
                                    ...
                                    soul::parser::Match* parentMatch14 = &match;
                                    {
                                        ...
                                        soul::parser::Match* parentMatch15 = &match;
                                        {
                                            ...
                                            if (match.hit)
                                            {
                                                condCompStmt.reset(new cmajor::ast::ConditionalCompilationStatementNode(s, ifExpr.release()));
                                            }
                                            *parentMatch15 = match;
                                        }
                                        *parentMatch14 = match;
                                                    ...
                                                    if (match.hit)
                                                    {
                                                        ...
                                                        soul::parser::Match* parentMatch34 = &match;
                                                        {
                                                            ...
                                                            soul::parser::Match* parentMatch35 = &match;
                                                            {
                                                                ...
                                                                if (match.hit)
                                                                {
                                                                    condCompStmt->AddElifExpr(elifSpan, elifExpr.release());
                                                                }
                                                                *parentMatch35 = match;
                                                            }
                                                            *parentMatch34 = match;
                                                ...
                                                int64_t save = lexer.GetPos();
                                                {
                                                    ...
                                                    soul::parser::Match* parentMatch51 = &match;
                                                    {
                                                        ...
                                                        soul::parser::Match* parentMatch52 = &match;
                                                        {
                                                            ...
                                                            if (match.hit)
                                                            {
                                                                condCompStmt->AddElseStatement(elseSpan, elses.release());
                                                            }
                                                            *parentMatch52 = match;
                                                        }
                                                        *parentMatch51 = match;
                    ...
                    soul::parser::Match* parentMatch54 = &match;
                    {
                        ...
                        soul::parser::Match* parentMatch55 = &match;
                        {
                            ...
                            soul::parser::Match* parentMatch56 = &match;
                            {
                                ...
                                if (match.hit)
                                {
                                    condCompStmt->SetEndIfSpan(lexer.GetSpan(pos));
                                }
                                *parentMatch56 = match;
                            }
                            *parentMatch55 = match;
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        soul::parser::Match* parentMatch8 = &match;
                                        {
                                            ...
                                            soul::parser::Match* parentMatch9 = &match;
                                            {
                                                ...
                                                if (match.hit)
                                                {
                                                    expr.reset(new cmajor::ast::ConditionalCompilationDisjunctionNode(s, expr.release(), right.release()));
                                                }
                                                *parentMatch9 = match;
                                            }
                                            *parentMatch8 = match;
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        soul::parser::Match* parentMatch8 = &match;
                                        {
                                            ...
                                            soul::parser::Match* parentMatch9 = &match;
                                            {
                                                ...
                                                if (match.hit)
                                                {
                                                    expr.reset(new cmajor::ast::ConditionalCompilationConjunctionNode(s, expr.release(), right.release()));
                                                }
                                                *parentMatch9 = match;
                                            }
                                            *parentMatch8 = match;
                        ...
                        if (match.hit)
                        {
                            ...
                            soul::parser::Match* parentMatch6 = &match;
                            {
                                ...
                                soul::parser::Match* parentMatch7 = &match;
                                {
                                    ...
                                    if (match.hit)
                                    {
                                        expr.reset(new cmajor::ast::ConditionalCompilationNotNode(s, prefix.release()));
                                    }
                                    *parentMatch7 = match;
                                }
                                *parentMatch6 = match;
                    ...
                    {
                        {
                            ...
                            #endif
                            return soul::parser::Match(true, new cmajor::ast::ConditionalCompilationPrimaryNode(lexer.GetSpan(pos), lexer.GetToken(pos).ToString()));
                        }
                    }
                    *parentMatch2 = match;
                }
                            ...
                            {
                                {
                                    ...
                                    if (parser_debug_write_to_log) soul::lexer::WriteSuccessToLog(lexer, parser_debug_match_pos, "ConditionalCompilationPrimary");
                                    #endif
                                    return soul::parser::Match(true, new cmajor::ast::ParenthesizedConditionalCompilationExpressionNode(s, expr.release()));
                                }
                            }
                            *parentMatch8 = match;
                        }
