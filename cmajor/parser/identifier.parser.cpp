...
// this file has been automatically generated from 'D:/work/cmajor-mod/cmajor/parser/identifier.parser' using soul parser generator spg version 5.0.0

module cmajor.identifier.parser;
...
soul::parser::Match IdentifierParser<LexerT>::Identifier(LexerT& lexer, cmajor::parser::context::Context* context)
{
    ...
    #endif
    soul::lexer::RuleGuard<LexerT> ruleGuard(lexer, 3562699651482124289);
...
template<typename LexerT>
soul::parser::Match IdentifierParser<LexerT>::QualifiedId(LexerT& lexer, cmajor::parser::context::Context* context)
{
    #ifdef SOUL_PARSER_DEBUG_SUPPORT
    int64_t parser_debug_match_pos = 0;
    bool parser_debug_write_to_log = lexer.Log() != nullptr;
    ...
    #endif
    soul::lexer::RuleGuard<LexerT> ruleGuard(lexer, 3562699651482124290);
                                    ...
                                    if (match.hit)
                                    {
                                        ...
                                        soul::parser::Match* parentMatch8 = &match;
                                        {
                                            ...
                                            soul::parser::Match* parentMatch9 = &match;
                                            {
                                                ...
                                                if (match.hit)
                                                {
                                                    value.append(1, '.').append(lexer.GetToken(pos).ToString());
                                                }
                                                *parentMatch9 = match;
                                            }
                                            *parentMatch8 = match;
...
template struct IdentifierParser<soul::lexer::Lexer<cmajor::lexer::CmajorLexer<char32_t>, char32_t>>;
