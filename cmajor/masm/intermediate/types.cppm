...
export module cmajor.masm.intermediate.types;
...
{
public:
    Type(const soul::ast::Span& span_, TypeKind kind_, int32_t id_);
    virtual ~Type();
...
public:
    TypeRef();
    TypeRef(const soul::ast::Span& span_, int32_t id_);
    const soul::ast::Span& Span() const { return span; }
    int32_t Id() const { return id; }
...
inline TypeRef MakeTypeRef(const soul::ast::Span& span, int32_t baseTypeId, int32_t pointerCount)
{
...
{
public:
    StructureType(const soul::ast::Span& span_, int32_t typeId_, const std::vector<TypeRef>& fieldTypeRefs_);
...
{
public:
    ArrayType(const soul::ast::Span& span_, int32_t typeId_, int64_t elementCount_, const TypeRef& elementTypeRef_);
    void Accept(Visitor& visitor) override;
    void Add(Types* types, Context* context) override;
    void Resolve(Types* types, Context* context) override;
    int64_t Size() const override;
...
{
public:
    FunctionType(const soul::ast::Span& span_, int32_t typeId_, const TypeRef& returnTypeRef_, const std::vector<TypeRef>& paramTypeRefs_);
    void Accept(Visitor& visitor) override;
    void Add(Types* types, Context* context) override;
    void Resolve(Types* types, Context* context) override;
    bool IsWeakType() const override;
...
{
public:
    PointerType(const soul::ast::Span& span_, int32_t typeId_, int8_t pointerCount_, int32_t baseTypeId_);
