...
std::map<int64_t, std::string>* GetRuleNameMapPtr()
{
    ...
    static std::map<int64_t, std::string> ruleNameMap = {
        ...
        { 5911887668215545895, "IntermediateParser.FunctionDefinition" },
        { 5911887668215545896, "IntermediateParser.FunctionHeader" },
        { 5911887668215545897, "IntermediateParser.BasicBlock" },
        { 5911887668215545898, "IntermediateParser.Label" },
        { 5911887668215545899, "IntermediateParser.Operand" },
        { 5911887668215545900, "IntermediateParser.Instructions" },
        { 5911887668215545901, "IntermediateParser.Instruction" },
        { 5911887668215545902, "IntermediateParser.StoreInstruction" },
        { 5911887668215545903, "IntermediateParser.ArgInstruction" },
        { 5911887668215545904, "IntermediateParser.JmpInstruction" },
        { 5911887668215545905, "IntermediateParser.BranchInstruction" },
        { 5911887668215545906, "IntermediateParser.ProcedureCallInstruction" },
        { 5911887668215545907, "IntermediateParser.RetInstruction" },
        { 5911887668215545908, "IntermediateParser.SwitchInstruction" },
        { 5911887668215545909, "IntermediateParser.ValueInstruction" },
        { 5911887668215545910, "IntermediateParser.Operation" },
        { 5911887668215545911, "IntermediateParser.UnaryInstruction" },
        { 5911887668215545912, "IntermediateParser.BinaryInstruction" },
        { 5911887668215545913, "IntermediateParser.ParamInstruction" },
        { 5911887668215545914, "IntermediateParser.LocalInstruction" },
        { 5911887668215545915, "IntermediateParser.LoadInstruction" },
        { 5911887668215545916, "IntermediateParser.ElemAddrInstruction" },
        { 5911887668215545917, "IntermediateParser.PtrOffsetInstruction" },
        { 5911887668215545918, "IntermediateParser.PtrDiffInstruction" },
        { 5911887668215545919, "IntermediateParser.FunctionCallInstruction" },
        { 5911887668215545920, "IntermediateParser.BlockValue" },
        { 5911887668215545921, "IntermediateParser.NoOperationInstruction" }
    };
    return &ruleNameMap;
}
