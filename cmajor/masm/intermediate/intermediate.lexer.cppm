...
export namespace cmajor::masm::intermediate::lexer {
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>("cmajor.masm.intermediate.lexer.classmap");
    return classmap;
}
...
{
    static soul::lexer::ClassMap<Char>* classmap = soul::lexer::MakeClassMap<Char>(moduleFileName, "cmajor.masm.intermediate.lexer.classmap", resourceFlags);
    return classmap;
}
...
} // namespace cmajor::masm::intermediate::lexer
