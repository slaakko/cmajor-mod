...
export module cmajor.masm.backend.emitter;

import cmajor.masm.backend.value.stack;
...
class MasmEmitter : public cmajor::ir::Emitter
{
public:
    MasmEmitter(cmajor::ir::EmittingContext* emittingContext_);
...
private:
    ...
    ValueStack stack;
    cmajor::masm::ir::Context* context;
    cmajor::masm::ir::CompileUnit* compileUnit;
    cmajor::masm::ir::Function* currentFunction;
    cmajor::masm::ir::Value* objectPointer;
    std::map<void*, cmajor::masm::ir::FunctionType*> functionIrTypeMap;
    std::map<util::uuid, cmajor::masm::ir::Type*> irTypeTypeIdMap;
    std::map<void*, cmajor::masm::ir::Value*> irObjectMap;
    std::set<void*> vmtObjectCreatedSet;
