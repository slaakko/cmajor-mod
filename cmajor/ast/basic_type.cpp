...
SByteNode::SByteNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::sbyteNode, sourcePos_, moduleId_)
{
}
...
ByteNode::ByteNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::byteNode, sourcePos_, moduleId_)
{
}
...
ShortNode::ShortNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::shortNode, sourcePos_, moduleId_)
{
}
...
UShortNode::UShortNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::ushortNode, sourcePos_, moduleId_)
{
}
...
IntNode::IntNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::intNode, sourcePos_, moduleId_)
{
}
...
UIntNode::UIntNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::uintNode, sourcePos_, moduleId_)
{
}
...
LongNode::LongNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::longNode, sourcePos_, moduleId_)
{
}
...
ULongNode::ULongNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::ulongNode, sourcePos_, moduleId_)
{
}
...
FloatNode::FloatNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::floatNode, sourcePos_, moduleId_)
{
}
...
DoubleNode::DoubleNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::doubleNode, sourcePos_, moduleId_)
{
}
...
CharNode::CharNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::charNode, sourcePos_, moduleId_)
{
}
...
WCharNode::WCharNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::wcharNode, sourcePos_, moduleId_)
{
}
...
UCharNode::UCharNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::ucharNode, sourcePos_, moduleId_)
{
}
...
VoidNode::VoidNode(const soul::ast::SourcePos& sourcePos_, const util::uuid& moduleId_) : Node(NodeType::voidNode, sourcePos_, moduleId_)
{
}
