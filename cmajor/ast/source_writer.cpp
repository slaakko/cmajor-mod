...
{
    formatter.Write("'");
    formatter.Write(util::CharStr(charLiteralNode.Value()));
    formatter.Write("'");
}
...
{
    formatter.Write("w'");
    formatter.Write(util::ToUtf8(util::CharStr(char32_t(wcharLiteralNode.Value()))));
    formatter.Write("'");
}
...
{
    formatter.Write("u'");
    formatter.Write(util::ToUtf8(util::CharStr(ucharLiteralNode.Value())));
    formatter.Write("'");
}
...
{
    formatter.Write("\"");
    formatter.Write(util::StringStr(stringLiteralNode.Value()));
    formatter.Write("\"");
}
...
{
    formatter.Write("w\"");
    formatter.Write(util::StringStr(util::ToUtf8(wstringLiteralNode.Value())));
    formatter.Write("\"");
}
...
{
    formatter.Write("u\"");
    formatter.Write(util::StringStr(util::ToUtf8(ustringLiteralNode.Value())));
    formatter.Write("\"");
}
...
void SourceWriter::Visit(NamespaceNode& namespaceNode)
{
    ...
    if (!namespaceNode.Id()->Str().empty())
    {
        ...
        {
            formatter.WriteLine("} // namespace " + util::ToUtf8(namespaceNode.Id()->Str()));
        }
    }
    emptyLine = true;
}
...
{
    formatter.Write(util::ToUtf8(identifierNode.Str()));
}
...
void SourceWriter::Visit(FunctionNode& functionNode)
{
    ...
    formatter.Write(" ");
    formatter.Write(util::ToUtf8(functionNode.GroupId()));
...
void SourceWriter::Visit(MemberFunctionNode& memberFunctionNode)
{
    ...
    formatter.Write(" ");
    formatter.Write(util::ToUtf8(memberFunctionNode.GroupId()));
    formatter.Write("(");
...
void SourceWriter::Visit(MemberFunctionConstraintNode& memberFunctionConstraintNode)
{
    ...
    formatter.Write(".");
    formatter.Write(util::ToUtf8(memberFunctionConstraintNode.GroupId()));
    formatter.Write("(");
...
void SourceWriter::Visit(FunctionConstraintNode& functionConstraintNode)
{
    ...
    formatter.Write(" ");
    formatter.Write(util::ToUtf8(functionConstraintNode.GroupId()));
    formatter.Write("(");
...
{
    formatter.Write(util::ToUtf8(labelNode.Label()));
    formatter.Write(": ");
}
...
void SourceWriter::Visit(GotoStatementNode& gotoStatementNode)
{
    ...
    formatter.Write(util::ToUtf8(gotoStatementNode.Target()));
    formatter.WriteLine(";");
}
...
{
    formatter.Write(util::ToUtf8(conditionalCompilationPrimaryNode.Symbol()));
}
...
{
    formatter.Write(util::ToUtf8(attribute.Name()));
    if (!attribute.Value().empty())
    {
        formatter.Write("=");
        formatter.Write("\"" + util::StringStr(util::ToUtf8(attribute.Value())) + "\"");
    }
}
...
{
    formatter.WriteLine("// " + util::ToUtf8(comment.Comment()));
    formatter.WriteLine();
}
