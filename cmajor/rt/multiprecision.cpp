...
module cmajor.rt.multiprecision;

import cmajor.rt.string;
import util.multiprecision;

void* RtCreateDefaultBigInt(int32_t& errorStrHandle)
{
    try
    {
        return new util::BigInt();
    }
...
void* RtCreateBigIntFromCopy(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigInt(*static_cast<util::BigInt*>(handle));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
{
    delete static_cast<util::BigInt*>(handle);
}
...
const char* RtBigIntToCharPtr(void* handle, int32_t& errorStrHandle)
{
    try
    {
        std::string s = static_cast<util::BigInt*>(handle)->ToString();
        int n = s.length() + 1;
        char* p = new char[n];
        memcpy(p, s.c_str(), n);
        return p;
...
int32_t RtBigIntToInt(void* handle, int32_t& errorStrHandle)
{
    ...
    {
        errorStrHandle = -1;
        return static_cast<util::BigInt*>(handle)->ToInt();
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
uint32_t RtBigIntToUInt(void* handle, int32_t& errorStrHandle)
{
    ...
    {
        errorStrHandle = -1;
        return static_cast<util::BigInt*>(handle)->ToUInt();
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
int64_t RtBigIntToLong(void* handle, int32_t& errorStrHandle)
{
    ...
    {
        errorStrHandle = -1;
        return static_cast<util::BigInt*>(handle)->ToLong();
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
uint64_t RtBigIntToULong(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return static_cast<util::BigInt*>(handle)->ToULong();
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtAddBigInt(void* left, void* right, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigInt(*static_cast<util::BigInt*>(left) + *static_cast<util::BigInt*>(right));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtShiftLeftBigInt(void* left, int32_t right, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigInt(*static_cast<util::BigInt*>(left) << right);
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
bool RtEqualBigInt(void* left, void* right, int32_t& errorStrHandle)
{
    ...
    {
        errorStrHandle = -1;
        return *static_cast<util::BigInt*>(left) == *static_cast<util::BigInt*>(right);
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtCreateBigRationalFromCopy(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigRational(*static_cast<util::BigRational*>(handle));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtCreateBigRationalFromBigInt(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigRational(*static_cast<util::BigInt*>(handle));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtCreateBigRationalFromBigInts(void* numerator, void* denominator, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigRational(*static_cast<util::BigInt*>(numerator), *static_cast<util::BigInt*>(denominator));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
{
    delete static_cast<util::BigRational*>(handle);
}
...
const char* RtBigRationalToCharPtr(void* handle, int32_t& errorStrHandle)
{
    try
    {
        std::string s = static_cast<util::BigRational*>(handle)->ToString();
        int n = s.length() + 1;
        char* p = new char[n];
        memcpy(p, s.c_str(), n);
        return p;
...
void* RtBigRationalToBigInt(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigInt(static_cast<util::BigRational*>(handle)->ToBigInt());
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtAddBigRational(void* left, void* right, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigRational(*static_cast<util::BigRational*>(left) + *static_cast<util::BigRational*>(right));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
bool RtEqualBigRational(void* left, void* right, int32_t& errorStrHandle)
{
    ...
    {
        errorStrHandle = -1;
        return *static_cast<util::BigRational*>(left) == *static_cast<util::BigRational*>(right);
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtNumeratorBigRational(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigInt(util::Numerator(*static_cast<util::BigRational*>(handle)));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtDenominatorBigRational(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigInt(util::Denominator(*static_cast<util::BigRational*>(handle)));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtCreateBigFloatFromCopy(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigFloat(*static_cast<util::BigFloat*>(handle));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtCreateBigFloatFromBigInt(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigFloat(*static_cast<util::BigInt*>(handle));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtCreateBigFloatFromBigRational(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigFloat(*static_cast<util::BigRational*>(handle));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
{
    delete static_cast<util::BigFloat*>(handle);
}
...
const char* RtBigFloatToCharPtr(void* handle, int32_t& errorStrHandle)
{
    try
    {
        std::string s = static_cast<util::BigFloat*>(handle)->ToString();
        int n = s.length() + 1;
        char* p = new char[n];
        memcpy(p, s.c_str(), n);
        return p;
...
double RtBigFloatToDouble(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return static_cast<util::BigFloat*>(handle)->ToDouble();
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtBigFloatToBigInt(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigInt(static_cast<util::BigFloat*>(handle)->ToBigInt());
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtBigFloatToBigRational(void* handle, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigRational(static_cast<util::BigFloat*>(handle)->ToBigRational());
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
void* RtAddBigFloat(void* left, void* right, int32_t& errorStrHandle)
{
    try
    {
        return new util::BigFloat(*static_cast<util::BigFloat*>(left) + *static_cast<util::BigFloat*>(right));
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
...
bool RtEqualBigFloat(void* left, void* right, int32_t& errorStrHandle)
{
    ...
    {
        errorStrHandle = -1;
        return *static_cast<util::BigFloat*>(left) == *static_cast<util::BigFloat*>(right);
    }
    catch (const std::exception& ex)
    {
        errorStrHandle = cmajor::rt::InstallString(ex.what());
