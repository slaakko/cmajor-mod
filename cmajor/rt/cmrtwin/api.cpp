...
#include <cmrtwin/api.hpp>
#include <cmrtwin/error.hpp>
#include <Windows.h>
#ifndef __MINGW32__
...
void WinInit(void* messageProcessorFunctionAddress, void* keyPreviewFunctionAddress)
{
    ...
    {
        cmrt::win::FatalGdiPlusError(status);
    }
}
...
bool WinGetFolder(void* windowHandle, const char16_t* defaultDirectory, char16_t* folderNameBuffer, uint32_t folderNameBufferSize)
{
    #pragma message("WinGetFolder not implemented for MINGW32")
    return false;
}
...
void* WinGraphicsPenGetBrush(void* pen)
{
    #pragma message("WinGraphicsPenGetBrush not implemented for MINGW32")
    return nullptr;
}
...
int WinGraphicsImageSave(void* image, const char* fileName, const void* encoderClsId)
{
    #pragma message("WinGraphicsImageSave not implemented for MINGW32")
    return 0;
}
