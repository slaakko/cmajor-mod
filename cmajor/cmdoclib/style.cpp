...
void GenerateCodeStyleFile()
{
    Input* input = GetInputPtr();
    std::string targetDir = input->targetDirPath;
    std::filesystem::create_directories(targetDir);
    std::string styleDir = util::GetFullPath(util::Path::Combine(targetDir, "style"));
    std::filesystem::create_directories(styleDir);
    std::string styleFileName = "code.css";
    std::string styleFilePath = util::GetFullPath(util::Path::Combine(styleDir, styleFileName));
